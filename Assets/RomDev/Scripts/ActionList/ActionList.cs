...
namespace RomDev
{
...
#endif
	{
		...
		#else
		[HideInInspector] public List<RomDev.Action> actions = new List<RomDev.Action> ();
		#endif
		...
		private void DownloadParameters ()
		{
			...
			if (source == ActionListSource.AssetFile)
			{
				...
				{
					foreach (RomDev.Action action in assetFile.actions)
					{
						actions.Add (action);
		 ...
		 */
		public static RomDev.Action GetDefaultAction ()
		{
