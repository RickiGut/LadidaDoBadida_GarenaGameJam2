...
namespace RomDev
{
	...
	public class JsonAction
	{
		...
		#endif
		private static RomDev.Action[] copiedActions = new RomDev.Action[0];
		...
		{
			copiedActions = new RomDev.Action[0];
		...
		public static List<Action> CreatePasteBuffer (bool clearIDs = true)
		{
			...
			List<RomDev.Action> tempList = new List<RomDev.Action>();
			foreach (RomDev.Action action in copiedActions)
			{
				if (action != null)
				{
			...
			foreach (RomDev.Action action in tempList)
			{
