...
namespace RomDev
{
	...
	public class ActionListAssetEditor : Editor
	{
		...
		private RomDev.Action actionToAffect;
		...
		public static Action RebuildAction (RomDev.Action action, int typeIndex, ActionListAsset _target, int insertIndex = -1, ActionEnd _end = null)
		{
		...
		public static void DeleteAction (RomDev.Action action, ActionListAsset _target)
		{
			if (action != null) 
			{
		...
		public static Action AddAction (RomDev.Action newAction, int i, ActionListAsset _target)
		{
			if (i < 0)
			{
		...
		private void ActionSideMenu (RomDev.Action action)
		{
			ActionListAsset _target = (ActionListAsset) target;
		...
		public static void ModifyAction (ActionListAsset _target, RomDev.Action _action, string callback)
		{
			ActionsManager actionsManager = AdvGame.GetReferences ().actionsManager;
			if (actionsManager == null)
			{
