...
namespace RomDev
{
	...
	public class KickStarter : MonoBehaviour
	{
					...
					if (playerPrefab)
					{
						...
						else if (settingsManager.playerSwitching == PlayerSwitching.Allow)
						{
							...
							if (!settingsManager.shareInventory)
							{
								...
								// Menus
								foreach (RomDev.Menu menu in PlayerMenus.GetMenus ())
								{
		 ...
		 */
		[HideInInspector] public const string AssemblyName = "Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
