...
namespace RomDev
{
	...
	public class ActionCharFollow : Action
	{
		 ...
		 */
		public static ActionCharFollow CreateNew_Start (NPC npcToMove, RomDev.Char characterToFollow, float minimumDistance, float maximumDistance, float updateFrequency = 2f, bool randomisePosition = false, bool faceCharacterWhenIdle = false)
		{
