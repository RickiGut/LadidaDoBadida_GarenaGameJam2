...
namespace RomDev
{
	...
	public class ActionCharPathFind : Action
	{
		...
		public override void ShowGUI (List<ActionParameter> parameters)
		{
			...
			positionOffsetParameterID = Action.ChooseParameterGUI ("Position offset:", parameters, positionOffsetParameterID, ParameterType.Vector3);
			if (positionOffsetParameterID < 0)
			{
