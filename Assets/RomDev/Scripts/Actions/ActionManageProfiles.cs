...
namespace RomDev
{
	...
	public class ActionManageProfiles : Action
	{
		...
		public override void ShowGUI (List<ActionParameter> parameters)
		{
			...
			if ((manageProfileType == ManageProfileType.CreateProfile && useCustomLabel) || manageProfileType == RomDev.ManageProfileType.RenameProfile)
			{
				customLabel = TextField ("Custom label:", customLabel);
			    ...
			    manageProfileType == ManageProfileType.SwitchActiveProfile)
			{
						 ...
						 deleteProfileType == DeleteProfileType.SlotIndexFromVariable)
				{
					...
					menuName = TextField ("Menu with ProfilesList:", menuName);
					elementName = TextField ("ProfilesList element:", elementName);
				}
			}
		}
