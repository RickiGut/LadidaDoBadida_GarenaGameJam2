	...
	public class ActionCharRender : Action
	{
		...
		public override void ShowGUI (List<ActionParameter> parameters)
		{
			...
			if (isPlayer)
			{
				...
				if (KickStarter.settingsManager != null && KickStarter.settingsManager.playerSwitching == PlayerSwitching.Allow)
				{
					if (parameterID < 0 && playerID >= 0)
					{
						...
						editorChar = (playerPrefab != null) ? playerPrefab.EditorPrefab : null;
					}
					else
					{
			...
			if (editorChar)
			{
				...
				if (editorChar.GetAnimEngine ())
				{
					editorChar.GetAnimEngine ().ActionCharRenderGUI (this, parameters);
		 ...
		 */
		public static ActionCharRender CreateNew_Mecanim (RomDev.Char characterToAffect, RenderLock sortingLock, int newSortingOrder, RenderLock scaleLock, int newScale)
		{
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharRender CreateNew_Mecanim (RomDev.Char characterToAffect, RenderLock sortingLock, string newSortingLayer, RenderLock scaleLock, int newScale)
		{
			ActionCharRender newAction = CreateNew<ActionCharRender> ();
			newAction._char = characterToAffect;
			newAction.TryAssignConstantID (newAction._char, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharRender CreateNew_Sprites (RomDev.Char characterToAffect, RenderLock sortingLock, int newSortingOrder, RenderLock scaleLock, int newScale, RenderLock directionLock, CharDirection newDirection, RenderLock sortingMapLock, SortingMap newSortingMap)
		{
			ActionCharRender newAction = CreateNew<ActionCharRender> ();
			newAction._char = characterToAffect;
			newAction.TryAssignConstantID (newAction._char, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharRender CreateNew_Sprites (RomDev.Char characterToAffect, RenderLock sortingLock, string newSortingLayer, RenderLock scaleLock, int newScale, RenderLock directionLock, CharDirection newDirection, RenderLock sortingMapLock, SortingMap newSortingMap)
		{
			ActionCharRender newAction = CreateNew<ActionCharRender> ();
			newAction._char = characterToAffect;
			newAction.TryAssignConstantID (newAction._char, ref newAction.constantID);
