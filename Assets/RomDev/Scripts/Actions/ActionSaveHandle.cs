...
namespace RomDev
{
	...
	public class ActionSaveHandle : Action
	{
		...
		public override void AssignValues (List<ActionParameter> parameters)
		{
			...
			if (customLabel && ((updateLabel && saveHandling == SaveHandling.OverwriteExistingSave && selectSaveType != SelectSaveType.Autosave) || saveHandling == RomDev.SaveHandling.SaveNewGame))
			{
