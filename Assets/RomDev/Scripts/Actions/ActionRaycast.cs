...
namespace RomDev
{
	...
	public class ActionRaycast : ActionCheck
	{
		...
		public override void ShowGUI (List<ActionParameter> parameters)
		{
			...
			{
				destinationTransformParameterID = Action.ChooseParameterGUI ("Destination:", parameters, destinationTransformParameterID, ParameterType.GameObject);
				if (destinationTransformParameterID < 0)
				{
					destinationTransform = (Transform) EditorGUILayout.ObjectField ("Destination:", destinationTransform, typeof (Transform), true);
					destinationTransformConstantID = FieldToID (destinationTransform, destinationTransformConstantID);
					destinationTransform = IDToField (destinationTransform, destinationTransformConstantID, false);
				}
			}
