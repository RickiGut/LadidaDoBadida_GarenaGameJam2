...
namespace RomDev
{
	...
	public class ActionCharFace : Action
	{
		 ...
		 */
		public static ActionCharFace CreateNew_BodyFace (RomDev.Char characterToTurn, GameObject objectToFace, bool useObjectRotation = false, bool isInstant = false, bool waitUntilFinish = false)
		{
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharFace CreateNew_HeadTurn (RomDev.Char characterToTurn, GameObject objectToFace, bool faceHeadIfCharacter = true, bool isInstant = false, bool waitUntilFinish = false)
		{
			ActionCharFace newAction = CreateNew<ActionCharFace> ();
			newAction.charToMove = characterToTurn;
			newAction.TryAssignConstantID (newAction.charToMove, ref newAction.charToMoveID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharFace CreateNew_HeadStop (RomDev.Char characterToTurn, bool isInstant = false)
		{
			ActionCharFace newAction = CreateNew<ActionCharFace> ();
			newAction.charToMove = characterToTurn;
			newAction.TryAssignConstantID (newAction.charToMove, ref newAction.charToMoveID);
