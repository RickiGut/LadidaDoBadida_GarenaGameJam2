...
namespace RomDev
{
	...
	public class ActionCharAnim : Action
	{
		 ...
		 */
		public static ActionCharAnim CreateNew_SpritesUnity_PlayCustom (RomDev.Char characterToAnimate, string clipName, bool addDirectionalSuffix = false, int layerIndex = 0, float transitionTime = 0f, bool waitUntilFinish = true, bool returnToIdleAfter = true)
		{
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_SpritesUnity_SetStandard (RomDev.Char characterToAnimate, AnimStandard standardToChange, string newStandardName, AudioClip newSound = null, float newSpeed = 0f)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_SpritesUnity_ResetToIdle (RomDev.Char characterToAnimate, bool waitForCustomAnimationToFinish = false)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_SpritesUnityComplex_PlayCustom (RomDev.Char characterToAnimate, string clipName, bool addDirectionalSuffix = false, int layerIndex = 0, float transitionTime = 0f, bool waitUntilFinish = true)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_SpritesUnityComplex_ChangeParameterValue (RomDev.Char characterToAnimate, string parameterName)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_SpritesUnityComplex_ChangeParameterValue (RomDev.Char characterToAnimate, string parameterName, int parameterValue)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_SpritesUnityComplex_ChangeParameterValue (RomDev.Char characterToAnimate, string parameterName, float parameterValue)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_SpritesUnityComplex_ChangeParameterValue (RomDev.Char characterToAnimate, string parameterName, bool parameterValue)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_SpritesUnityComplex_SetStandard (RomDev.Char characterToAnimate, MecanimCharParameter parameterToChange, string newParameterName)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_Mecanim_ChangeParameterValue (RomDev.Char characterToAnimate, string parameterName)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_Mecanim_ChangeParameterValue (RomDev.Char characterToAnimate, string parameterName, int parameterValue)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_Mecanim_ChangeParameterValue (RomDev.Char characterToAnimate, string parameterName, float parameterValue)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_Mecanim_ChangeParameterValue (RomDev.Char characterToAnimate, string parameterName, bool parameterValue)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_Mecanim_SetStandard (RomDev.Char characterToAnimate, MecanimCharParameter parameterToChange, string newParameterName)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharAnim CreateNew_Mecanim_PlayCustom (RomDev.Char characterToAnimate, string clipName, int layerIndex = 0, float transitionTime = 0f, bool waitUntilFinish = true)
		{
			ActionCharAnim newAction = CreateNew<ActionCharAnim> ();
			newAction.animChar = characterToAnimate;
			newAction.TryAssignConstantID (newAction.animChar, ref newAction.constantID);
