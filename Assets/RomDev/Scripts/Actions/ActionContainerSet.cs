...
namespace RomDev
{
	...
	public class ActionContainerSet : Action
	{
		...
		public override void ShowGUI (List<ActionParameter> parameters)
		{
			...
			{
				indexToRemoveParameterID = Action.ChooseParameterGUI ("Index:", parameters, indexToRemoveParameterID, ParameterType.Integer);
				if (indexToRemoveParameterID < 0)
				{
					indexToRemove = EditorGUILayout.IntField ("Index:", indexToRemove);
				}
			}
