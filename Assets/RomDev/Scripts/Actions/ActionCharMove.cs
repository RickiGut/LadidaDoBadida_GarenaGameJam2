...
namespace RomDev
{
	...
	public class ActionCharMove : Action
	{
		...
		public override void ShowGUI (List<ActionParameter> parameters)
		{
			...
			switch (movePathMethod)
			{
				case MovePathMethod.MoveOnNewPath:
				{
					...
					{
						nodeIndexParameterID = Action.ChooseParameterGUI ("Node index:", parameters, nodeIndexParameterID, ParameterType.Integer);
						if (nodeIndexParameterID < 0)
						{
							nodeIndex = EditorGUILayout.IntField ("Node index:", nodeIndex);
						}
					}
		 ...
		 */
		public static ActionCharMove CreateNew_NewPath (RomDev.Char characterToMove, Paths pathToFollow, bool teleportToStart = false)
		{
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharMove CreateNew_ResumeLastPath (RomDev.Char characterToMove)
		{
			ActionCharMove newAction = CreateNew<ActionCharMove> ();
		 ...
		 * <returns>The generated Action</returns>
		 */
		public static ActionCharMove CreateNew_StopMoving (RomDev.Char characterToStop, bool stopInstantly = false)
		{
			ActionCharMove newAction = CreateNew<ActionCharMove> ();
