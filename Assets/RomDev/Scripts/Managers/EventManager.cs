...
namespace RomDev
{
	...
	public class EventManager : MonoBehaviour
	{
		...
		public delegate void Delegate_StartSpeech (RomDev.Char speakingCharacter, string speechText, int lineID);
		/** A delegate for the OnStopSpeech event */
		public delegate void Delegate_StopSpeech (RomDev.Char speakingCharacter);
		...
		public delegate void Delegate_SpeechToken (RomDev.Char speakingCharacter, int lineID, string tokenKey, string tokenValue);
		 ...
		 */
		public void Call_OnStartSpeech (Speech speech, RomDev.Char speakingCharacter, string speechText, int lineID)
		{
		 ...
		 * <param name = "speakingCharacter">The character who is speaking. If null, the line is considered to be a narration</param>
		 */
		public void Call_OnStopSpeech (Speech speech, RomDev.Char speakingCharacter)
		{
		 ...
		 * <param name = "lineID">The ID number of the speech line, as generated by the SpeechManager</param>
		 */
		public void Call_OnStartSpeechScroll (Speech speech, RomDev.Char speakingCharacter, string speechText, int lineID)
		{
		 ...
		 * <param name = "lineID">The ID number of the speech line, as generated by the SpeechManager</param>
		 */
		public void Call_OnEndSpeechScroll (Speech speech, RomDev.Char speakingCharacter, string speechText, int lineID)
		{
		 ...
		 * <param name = "lineID">The ID number of the speech line, as generated by the SpeechManager</param>
		 */
		public void Call_OnCompleteSpeechScroll (Speech speech, RomDev.Char speakingCharacter, string speechText, int lineID)
		{
		...
		public delegate void Delegate_InteractHotspot (Hotspot hotspot, RomDev.Button button);
		/** A delegate for the OnHotspotSetInteractionState event */
		public delegate void Delegate_OnHotspotSetInteractionState (Hotspot hotspot, RomDev.Button button, bool newState);
		 ...
		 */
		public void Call_OnInteractHotspot (Hotspot hotspot, RomDev.Button button)
		{
			if (hotspot == null) return;
		 ...
		 */
		public void Call_OnDoubleClickHotspot (Hotspot hotspot, RomDev.Button button)
		{
			if (hotspot == null) return;
		 ...
		 * <param name = "button">The specific Button on the Hotspot that was interacted with. This will be null if the interaction is unhandled.</param>
		 */
		public void Call_OnHotspotReach (Hotspot hotspot, RomDev.Button button)
		{
			if (hotspot == null) return;
		...
		public delegate void Delegate_OnMenuElementClick (RomDev.Menu _menu, MenuElement _element, int _slot, int buttonPressed);
		/** A delegate for the OnMouseOverMenu event */
		public delegate void Delegate_OnMouseOverMenu (RomDev.Menu _menu, MenuElement _element, int _slot);
		...
		public delegate void Delegate_OnMenuTurnOn (RomDev.Menu _menu, bool isInstant);
		...
		public delegate string Delegate_OnRequestMenuElementHotspotLabel (RomDev.Menu _menu, MenuElement _element, int _slot, int _language);
		...
		public delegate void Delegate_OnHideSelectedElement (RomDev.Menu _menu, MenuElement _element, int _slot);
		 ...
		 */
		public void Call_OnMenuElementClick (RomDev.Menu menu, MenuElement element, int slot, int buttonPressed)
		{
		 ...
		 */
		public void Call_OnMouseOverMenuElement (RomDev.Menu menu, MenuElement element, int slot)
		{
		 ...
		 */
		public void Call_OnMenuTurnOn (RomDev.Menu menu, bool isInstant)
		{
		 ...
		 */
		public void Call_OnMenuTurnOff (RomDev.Menu menu, bool isInstant)
		{
		 ...
		 */
		public string Call_OnRequestMenuElementHotspotLabel (RomDev.Menu _menu, MenuElement _element, int _slot, int language)
		{
		 ...
		 */
		public void Call_OnHideSelectedElement (RomDev.Menu menu, MenuElement element, int slot)
		{
		...
		public delegate void Delegate_OnCharacterTimeline (RomDev.Char character, PlayableDirector director, int trackIndex);
		...
		public delegate void Delegate_OnCharacterEndPath (RomDev.Char character, Paths path);
		...
		public delegate void Delegate_OnCharacterSetPath (RomDev.Char character, Paths path);
		...
		public delegate void Delegate_OnCharacterReachNode (RomDev.Char character, Paths path, int node);
		...
		public delegate void Delegate_OnCharacterRecalculatePathfind (RomDev.Char character, ref Vector3 targetPosition);
		...
		public delegate void Delegate_SetHeadTurnTarget (RomDev.Char character, Transform headTurnTarget, Vector3 targetOffset, bool isInstant);
		...
		public delegate void Delegate_ClearHeadTurnTarget (RomDev.Char character, bool isInstant);
		...
		public delegate void Delegate_OnSetLookDirection (RomDev.Char character, Vector3 direction, bool isInstant);
		...
		public delegate void Delegate_OnCharacterSetExpression (RomDev.Char character, Expression expression);
		...
		public delegate void Delegate_OnCharacterTeleport (RomDev.Char character, Vector3 position, Quaternion rotation);
		...
		public delegate void Delegate_OnCharacterHoldObject (RomDev.Char character, GameObject heldObject, Hand hand);
		 ...
		 */
		public void Call_OnCharacterTimeline (RomDev.Char character, PlayableDirector director, int trackIndex, bool isEntering)
		{
			if (character != null)
			{
				if (isEntering)
		 ...
		 */
		public void Call_OnSetHeadTurnTarget (RomDev.Char character, Transform headTurnTarget, Vector3 targetOffset, bool isInstant)
		{
		 ...
		 */
		public void Call_OnClearHeadTurnTarget (RomDev.Char character, bool isInstant)
		{
		 ...
		 */
		public void Call_OnCharacterEndPath (RomDev.Char character, Paths path)
		{
		 ...
		 */
		public void Call_OnCharacterSetPath (RomDev.Char character, Paths path)
		{
		 ...
		 */
		public void Call_OnCharacterReachNode (RomDev.Char character, Paths path, int node)
		{
		 ...
		 */
		public void Call_OnSetLookDirection (RomDev.Char character, Vector3 direction, bool isInstant)
		{
		 ...
		 */
		public void Call_OnCharacterSetExpression (RomDev.Char character, Expression expression)
		{
		 ...
		 */
		public void Call_OnCharacterTeleport (RomDev.Char character, Vector3 position, Quaternion rotation)
		{
		 ...
		 */
		public void Call_OnCharacterRecalculatePathfind (RomDev.Char character, ref Vector3 destination)
		{
		 ...
		 */
		public void Call_OnCharacterHoldObject (RomDev.Char character, GameObject heldObject, Hand hand)
		{
		 ...
		 */
		public void Call_OnCharacterDropObject (RomDev.Char character, GameObject heldObject, Hand hand)
		{
		...
		public delegate void Delegate_PlayFootstepSound (RomDev.Char character, FootstepSounds footstepSounds, bool isWalkingSound, AudioSource audioSource, AudioClip audioClip);
		 ...
		 */
		public void Call_OnPlayFootstepSound (RomDev.Char character, FootstepSounds footstepSounds, bool isWalkingSound, AudioSource audioSource, AudioClip audioClip)
		{
