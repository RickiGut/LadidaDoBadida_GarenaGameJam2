...
namespace RomDev
{
	...
	public class NewGameWizardWindow : EditorWindow
	{
		...
		private void Finish ()
		{
			...
			string filteredName = string.Join ("_", gameName.Split (System.IO.Path.GetInvalidFileNameChars ()));
			string managerPath = filteredName + "/Managers";
			try
			{
			...
			try
			{
				...
				AssetDatabase.RenameAsset ("Assets/" + managerPath + "/SceneManager.asset", filteredName + "_SceneManager");
				...
				AssetDatabase.RenameAsset ("Assets/" + managerPath + "/SettingsManager.asset", filteredName + "_SettingsManager");
				...
				AssetDatabase.RenameAsset ("Assets/" + managerPath + "/ActionsManager.asset", filteredName + "_ActionsManager");
				...
				newActionsManager.defaultClassName = (defaultActionsManager != null) ? defaultActionsManager.defaultClassName : "ActionPause";
				...
				AssetDatabase.RenameAsset ("Assets/" + managerPath + "/VariablesManager.asset", filteredName + "_VariablesManager");
				...
				AssetDatabase.RenameAsset ("Assets/" + managerPath + "/InventoryManager.asset", filteredName + "_InventoryManager");
				...
				AssetDatabase.RenameAsset ("Assets/" + managerPath + "/SpeechManager.asset", filteredName + "_SpeechManager");
				...
				AssetDatabase.RenameAsset ("Assets/" + managerPath + "/CursorManager.asset", filteredName + "_CursorManager");
				...
				AssetDatabase.RenameAsset ("Assets/" + managerPath + "/MenuManager.asset", filteredName + "_MenuManager");
				...
				if (wizardMenu == WizardMenu.Blank)
				{
					if (defaultCursorManager != null)
					{
						...
						{
							CreateUICursorPrefab (defaultCursorManager.uiCursorPrefab, newCursorManager, "Assets/" + filteredName + "/" + defaultCursorManager.uiCursorPrefab.name + ".prefab");
						}
				...
				{
					System.IO.Directory.CreateDirectory (Application.dataPath + "/" + filteredName + "/UI");
					...
					if (defaultCursorManager)
					{
						...
						if (defaultCursorManager.uiCursorPrefab)
						{
							CreateUICursorPrefab (defaultCursorManager.uiCursorPrefab, newCursorManager, "Assets/" + filteredName + "/UI/" + defaultCursorManager.uiCursorPrefab.name + ".prefab");
						}
					...
					if (defaultMenuManager != null)
					{
						...
						foreach (Menu defaultMenu in defaultMenuManager.menus)
						{
							...
							if (defaultMenu.PrefabCanvas)
							{
								...
								string newPath = "Assets/" + filteredName + "/UI/" + defaultMenu.PrefabCanvas.name + ".prefab";
						...
						if (wizardMenu != WizardMenu.Blank)
						{
							System.IO.Directory.CreateDirectory (Application.dataPath + "/" + filteredName + "/UI/ActionLists");
						}

						string actionListPath = filteredName + "/UI/ActionLists";
				...
				ManagerPackage newManagerPackage = CreateManagerPackage (filteredName, newSceneManager, newSettingsManager, newActionsManager, newVariablesManager, newInventoryManager, newSpeechManager, newCursorManager, newMenuManager);
