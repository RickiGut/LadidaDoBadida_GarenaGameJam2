	...
	public class MenuManager : ScriptableObject
	{
		...
		public void CleanUpAsset ()
		{
			...
			foreach (Object _object in objects)
			{
				if (_object is Menu)
				{
					RomDev.Menu _menu = (Menu) _object;
		 ...
		 */
		public void SelectElementFromPreview (RomDev.Menu _menu, MenuElement _element)
		{
		...
		private void CreateElementsGUI (RomDev.Menu _menu)
		{
		...
		private void ActivateMenu (RomDev.Menu menu)
		{
			selectedMenu = menu;
		}
		...
		private void DeleteAllElements (RomDev.Menu menu)
		{
		...
		private void DeactivateAllElements (RomDev.Menu menu)
		{
			foreach (MenuElement menuElement in menu.elements)
			{
				if (menuElement != null)
		...
		private void AddElement (string className, RomDev.Menu _menu)
		{
		...
		private void SideMenu (RomDev.Menu _menu)
		{
		...
		private void SideMenu (RomDev.Menu _menu, MenuElement _element)
		{
			GenericMenu menu = new GenericMenu ();
		...
		public static MenuElement GetElementWithName (string menuName, string menuElementName)
		{
			...
			{
				foreach (RomDev.Menu menu in AdvGame.GetReferences ().menuManager.menus)
				{
