...
namespace RomDev
{
	...
	public static class ACDebug
	{
		...
		public static void Log (object message, ActionList actionList, RomDev.Action action, UnityEngine.Object context = null)
		{
			if (KickStarter.eventManager)
			{
				message = KickStarter.eventManager.Call_OnDebugLog (message, DebugLogType.Info, context, CanDisplay (DebugLogType.Info));
		...
		public static void LogWarning (object message, ActionList actionList, RomDev.Action action, UnityEngine.Object context = null)
		{
			if (KickStarter.eventManager)
			{
				message = KickStarter.eventManager.Call_OnDebugLog (message, DebugLogType.Warning, context, CanDisplay (DebugLogType.Warning));
		...
		public static void LogError (object message, ActionList actionList, RomDev.Action action, UnityEngine.Object context = null)
		{
			if (KickStarter.eventManager)
			{
				message = KickStarter.eventManager.Call_OnDebugLog (message, DebugLogType.Error, context, CanDisplay (DebugLogType.Error));
		...
		private static string GetActionListSuffix (ActionList actionList, RomDev.Action action)
		{
