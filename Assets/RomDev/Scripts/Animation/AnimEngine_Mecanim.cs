...
namespace RomDev
{
	...
	public class AnimEngine_Mecanim : AnimEngine
	{
		...
		public override void Declare (RomDev.Char _character)
		{
		...
		public override void ActionAnimGUI (ActionAnim action, List<ActionParameter> parameters)
		{
			...
			{
				action.parameterID = RomDev.Action.ChooseParameterGUI ("Animator:", parameters, action.parameterID, ParameterType.GameObject);
			...
			else if (action.methodMecanim == AnimMethodMecanim.BlendShape)
			{
				...
				if (!action.isPlayer)
				{
					action.parameterID = RomDev.Action.ChooseParameterGUI ("Object:", parameters, action.parameterID, ParameterType.GameObject);
					if (action.parameterID >= 0)
					{
						action.constantID = 0;
