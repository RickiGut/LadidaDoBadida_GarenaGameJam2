...
namespace RomDev
{
	...
	public class Speech
	{
		...
		public RomDev.Char speaker { get; protected set; }
		...
		public Speech (RomDev.Char _speaker, string _message)
		{
			log.Clear ();
		 ...
		 */
		public void EndBackgroundSpeechAudio (RomDev.Char newSpeaker)
		{
