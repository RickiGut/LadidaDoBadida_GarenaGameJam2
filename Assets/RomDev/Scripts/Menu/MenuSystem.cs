...
namespace RomDev
{
	...
	public class MenuSystem : MonoBehaviour
	{
		...
		public static void OnMenuEnable (RomDev.Menu _menu)
		{
		...
		public static void OnElementClick (RomDev.Menu _menu, MenuElement _element, int _slot, int _buttonPressed)
		{
