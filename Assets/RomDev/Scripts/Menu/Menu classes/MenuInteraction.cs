...
namespace RomDev
{
	...
	public class MenuInteraction : MenuElement
	{
		...
		public override void LoadUnityUI (RomDev.Menu _menu, Canvas canvas, bool addEventListeners = true)
		{
			if (fixedIcon)
			{
		 ...
		 */
		public void MatchInteractions (List<RomDev.Button> buttons)
		{
			if (!fixedIcon) return;

			bool match = false;
			
			foreach (RomDev.Button button in buttons)
			{
		 ...
		 */
		public void MatchUseInteraction (RomDev.Button button)
		{
		...
		public override bool ProcessClick (RomDev.Menu _menu, int _slot, MouseState _mouseState)
		{
