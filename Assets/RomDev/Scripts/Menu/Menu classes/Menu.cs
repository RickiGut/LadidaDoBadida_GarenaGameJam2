...
namespace RomDev
{
	...
	public class Menu : ScriptableObject
	{
		 ...
		 */
		public void CreateDuplicate (RomDev.Menu menuToCopy)
		{
		 ...
		 */
		public void Copy (RomDev.Menu _menu, bool fromEditor, bool forceUIFields = false)
		{
			...
			else
			{
				...
				else
				{
					if (KickStarter.menuManager.useAddressables)
					{
						...
						#else
						EditorGUILayout.HelpBox ("'AddressableIsPresent' scripting define symbol not found.", MessageType.Warning);
						#endif
					}
					else
					{
		...
		public void SetCentre3D (Vector3 _position)
		{
			if (IsUnityUI ())
			{
				...
				{
					rectTransform.transform.position = _position + new Vector3 (positionOffset.x, positionOffset.y);
