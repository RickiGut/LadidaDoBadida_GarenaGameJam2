...
namespace RomDev
{
	...
	public class MenuDrag : MenuElement, ITranslatable
	{
		...
		private RomDev.Menu menuToDrag;
		...
		public override void DrawOutline (bool isSelected, RomDev.Menu _menu)
		{
		...
		private void StartDrag (RomDev.Menu _menu)
		{
			menuToDrag = _menu;
		...
		public bool DoDrag (Vector2 _dragVector)
		{
			...
			else if (dragType == RomDev.DragElementType.SingleElement)
			{
