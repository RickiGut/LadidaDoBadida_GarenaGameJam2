...
namespace RomDev
{
	...
	public class MenuElement : ScriptableObject
	{
		 ...
		 */
		public virtual void Initialise (RomDev.Menu _menu)
		{
			parentMenu = _menu;
		}
		 ...
		 */
		public virtual void LoadUnityUI (RomDev.Menu _menu, Canvas canvas, bool addEventListeners = true)
		{}


		protected void CreateUIEvent (UnityEngine.UI.Button uiButton, RomDev.Menu _menu, UIPointerState uiPointerState = UIPointerState.PointerClick, int _slotIndex = 0, bool liveState = true)
		{
		...
		protected void CreateHoverSoundHandler (Selectable selectable, RomDev.Menu _menu, int _slotIndex = 0)
		{
			if (selectable == null)
			{
		...
		protected virtual void ProcessClickUI (RomDev.Menu _menu, int _slot, MouseState _mouseState)
		{
		 ...
		 */
		public virtual bool ProcessClick (RomDev.Menu _menu, int _slot, MouseState _mouseState)
		{
			if (clickSound)
			{
		 ...
		 */
		public virtual bool ProcessContinuousClick (RomDev.Menu _menu, MouseState _mouseState)
		{
			return false;
		}
		 ...
		 * <param name = "_menu">The element's parent Menu</param>
		 */
		public virtual void DrawOutline (bool isSelected, RomDev.Menu _menu)
		{
		 ...
		 */
		public Vector2[] GetSlotCentres (RomDev.Menu _menu)
		{
