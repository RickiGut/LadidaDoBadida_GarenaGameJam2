...
namespace RomDev
{
	...
	public class NavigationEngine : ScriptableObject
	{
		 ...
		 */
		public virtual Vector3[] GetPointsArray (Vector3 startPosition, Vector3 targetPosition, RomDev.Char _char = null)
		{
		 ...
		 * <returns>The path to take, as an array of Vector3s.</returns>
		 */
		public Vector3[] GetPointsArray (Vector3 startPosition, Vector3[] targetPositions, RomDev.Char _char = null)
		{
