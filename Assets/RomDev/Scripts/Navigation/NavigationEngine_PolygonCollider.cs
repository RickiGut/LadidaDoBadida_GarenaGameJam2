...
namespace RomDev
{
	...
	public class NavigationEngine_PolygonCollider : NavigationEngine
	{
		...
		public override Vector3[] GetPointsArray (Vector3 _originPos, Vector3 _targetPos, RomDev.Char _char = null)
		{
		...
		protected void AddCharHoles (PolygonCollider2D[] navPolys, RomDev.Char charToExclude, NavigationMesh navigationMesh)
		{
