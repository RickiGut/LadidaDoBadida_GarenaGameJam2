...
namespace RomDev
{
	...
	public class ConversationEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			_target.interactionSource = (RomDev.InteractionSource) CustomGUILayout.EnumPopup ("Interaction source:", _target.interactionSource, "", "The source of the commands that are run when an option is chosen");
		...
		private void EditOptionGUI (ButtonDialog option, InteractionSource source)
		{
			...
			else
			{
				...
				if (option.conversationAction == RomDev.ConversationAction.RunOtherConversation)
				{
