	...
	public class HotspotEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			else
			{
				...
				_target.interactionSource = (RomDev.InteractionSource) CustomGUILayout.EnumPopup ("Interaction source:", _target.interactionSource, string.Empty, "The source of the commands that are run when an option is chosen");
