...
namespace RomDev
{
	...
	public class Char : MonoBehaviour, ITranslatable
	{
		...
		protected GameObject leftHandHeldObject;
		protected GameObject rightHandHeldObject;
		 ...
		 * <param name = "hand">Which hand to drop from</param<
		 ...
		 */
		public GameObject ReleaseHeldObject (Hand hand, bool delete)
		{
