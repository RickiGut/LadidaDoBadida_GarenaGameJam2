...
namespace RomDev
{
	...
	*/
	...
	public abstract class Remember : ConstantID
	{
		...
		/**
		 * <summary>Deserialises a string of data, and restores the GameObject to its previous state. By default, this just runs LoadData - only override this if the loading process takes multiple frames</summary>
		 * <param name = "stringData">The data, serialised as a string</param>
		 */
		public virtual IEnumerator LoadDataCo (string stringData)
		{
			LoadData (stringData);
			yield break;
		}
