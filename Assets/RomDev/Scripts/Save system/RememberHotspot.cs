...
namespace RomDev
{
	...
	public class RememberHotspot : Remember
	{
		...
		private string ButtonStatesToString (Hotspot hotspot)
		{
			...
			{
				foreach (RomDev.Button button in hotspot.useButtons)
				{
			...
			{
				foreach (RomDev.Button button in hotspot.invButtons)
				{
					stateString.Append (GetButtonDisabledValue (button));
		...
		private string GetButtonDisabledValue (RomDev.Button button)
		{
